...
class T1DPatient(Patient):
    ...
    def model(t, x, action, params, last_Qsto, last_foodtaken, PAparams, beta, uhr, uhr_end, t_start, t_end, to_record_model_eq=False, testing_GI_limits=False):
        dxdt = np.zeros(13 + 2 + (100+1)*3)  # + dxdt[-2] = dydx, dxdt[-1] = dzdt   + (100+1) (dxdt[0], dxdt[1], dxdt[2])
        ...
        # the glucose rate of appearance constant (Rat) independently for 101
    ...
    def reset(self):
        ...
        # Adding y0=0, z0=0 to init state + 3*(100+1) (X[0]0=0, x[1]0=0, x[2]0=0)
